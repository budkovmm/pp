...
func (_m *RoleRepository) Create(name model.RoleName) (*model.Role, error) {
	ret := _m.Called(name)
...
func (_m *RoleRepository) Delete(id model.RoleID) error {
	ret := _m.Called(id)
...
func (_m *RoleRepository) GetById(id model.RoleID) (*model.Role, error) {
	ret := _m.Called(id)
...
func (_m *RoleRepository) GetAll(limit int, offset int) ([]model.Role, error) {
...
func (_m *RoleRepository) Update(id model.RoleID, name model.RoleName) (*model.Role, error) {
